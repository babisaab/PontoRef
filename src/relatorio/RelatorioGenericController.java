...
public class RelatorioGenericController extends HttpServlet <T extends EntidadeBase> {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio") + "/"+this.acao;

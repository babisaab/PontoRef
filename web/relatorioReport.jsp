...
<body>
    ...
    <h1> Relatórios com Parâmetro </h1>
    <ul>
        <li><a href="informeReport.jsp"><span title="Relatorio">Relatórios de Informes</span></a></li>
        <li><a href="horarioReport.jsp"><span title="Relatorio">Relatórios de Horários</span></a></li>
        <li><a href="afastamentoReport.jsp"><span title="Relatorio">Relatórios de Afastamento</span></a></li>
        <li><a href="cartaoReport.jsp"><span title="Relatorio">Relatórios de Cartão</span></a></li>
        <li><a href="report.jsp"><span title="Relatorio">Relatórios de Funcionários</span></a></li>
    </ul>
</body>

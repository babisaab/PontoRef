            ...
            <c:forEach items="${informes}" var="informe">
                <tr>
                    ...
                    <c:if test="${acao != 'Only'}">
                        ...
                        <td><a href=
                           "InformeController?acao=prepararOperacao&operacao=Editar&id=${informe.id}">Editar</a></td>
                        <td><a href=
                           "InformeController?acao=prepararOperacao&operacao=Excluir&id=${informe.id}">Excluir</a></td>
                    </c:if>
                </tr>
            </c:forEach>
        </table>
        <c:if test="${acao != 'Only'}">
            <form action="InformeController?acao=prepararOperacao&operacao=Incluir" method="post">
